                    ...
                    <div class="single__breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb__item"><a href="/" class="breadcrumb__link link">Виллы</a></li>
            ...
            <div class="row">
                <div class="col-12 col-xl-10 offset-xl-1 ">
                    ...
                    <ul class="custom-list single-description__custom-list">
                        <li class="custom-list__item">Отличное качество</li>
                        <li class="custom-list__item">Строительство соответствует европейскому стандарту</li>
                        <li class="custom-list__item">Внедрение новых концепций</li>
                        <li class="custom-list__item">Покупка "Всё включено"</li>
                        <li class="custom-list__item">Наши собственные работники являются гарантией хорошей работы</li>
                        <li class="custom-list__item">Страсть к строительству</li>
                        <li class="custom-list__item">Цена соответствует качеству</li>
                        <li class="custom-list__item">Семейный бизнес многих лет</li>
                        <li class="custom-list__item">Полный послепродажный сервис</li>
                    </ul> 
