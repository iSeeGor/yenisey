            ...
            <div class="row coop-whyUs__row">
                <div class="col-lg-6 order-1 order-lg-0">
                    ...
                    <div class="coop-whyUs__textarea">
                        ...
                        <p>Наши проекты пользуются большим спросом среди покупателей из разных стран мира,
                            поэтому «Yenisey» по праву занимает лидирующие позиции среди строительных
                            компаний в Алании. </p>
                        <p>Мы заслужили свою репутацию благодаря упорному труду,
                            скрупулезной точности, постоянному обучению и использованию новых технологий в
                            строительстве.</p>
                        <p>Для реализации крупных строительных проектов требуется четкая организация
                            производственного процесса, сплоченный коллектив, высококвалифицированные
                            специалисты и собственные производственные мощности. </p>
                        <p>Бесценный практический опыт,
                            впечатляющий портфель уже реализованных проектов, которые в полной мере
                            демонстрируют нашу компетенцию – ещё одно преимущество нашей компании.</p>
                    </div>
                </div>
