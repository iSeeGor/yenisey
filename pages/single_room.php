...
<main class="main-content main-single single">
    ...
    <!--== Single Content -->
    <div class="single-content single-room">
        <div class="container">
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    <h1 class="single__title">Yenisey Residence 2+1 All included</h1>
                </div>
            </div>

            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    <div class="meta single_meta row">
        ...
        <div class="image-slider single__image-slider">
            <div class="container">
                <div class="row">
                    <div class="col-xl-10 offset-xl-1">
                        <!--== Main Slider -->
                    ...
                    <div class="col-12 col-xl-10 offset-xl-1">
                        ...
                        <div class="player-box single-description__video-box">
                            <div class="player-box__row">
                                ...
                                <iframe class="player-box__iframe" ssrc="https://www.youtube.com/embed/p8jZjfUlTBM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                        </div>    
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-xl-10 offset-xl-1">
                        ...
                        <div class="row single-propery__row">
                            <div class="col-12">
                                <h3 class="single-section__title">Инфраструктура комплекса</h3>
                            </div>
                        ...
                        <div class="row single-propery__row">
                            <div class="col-12">
                                <h3 class="single-section__title">Комплектация квартиры</h3>
                            </div>
        ...
        <section class="product-list single__prodList single-prodList">
            <div class="container">
        ...
        <section class="managers single__managers single-managers">
            <div class="container">
                <div class="row">
                    <div class="col-12">
