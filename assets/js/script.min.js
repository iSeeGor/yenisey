...
const phoneListToggle = () => {// let button = window.getComputedStyle(document.querySelector('.phones__select-list'), ':after').;
}; // Custom Select's
...
const swiperTestimonial = () => {
  ...
  let testimonialsSlider = new Swiper(".testimonial__slider", {
    ...
    navigation: {
      ...
      prevEl: ".testimonial__button-prev" // And if we need scrollbar
      // scrollbar: {
      //   el: '.swiper-scrollbar',
      // },
  ...
  const breakpointProd = window.matchMedia('(min-width:767px)'); //BreackPoint Two For Products 
