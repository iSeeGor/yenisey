...
const accordionMenu = () => {
  let Accordion = function (el, multiple) {
    ...
    let links = this.el.find(".link"); // Evento
...
const modalTheme = () => {
  ...
  let closeBtn = document.querySelector(".popup__close-btn"); // Modal Form

  let popup = document.querySelector(".popup");
  let openPopup = document.querySelectorAll(".button__popup");
  let popupTitle = document.querySelector(".popup__title");
  let popupText = document.querySelector(".popup__text"); // Modal Video  
  ...
  let mainSliderOptions = {
    ...
    on: {
      ...
      imagesReady: function () {
        this.el.classList.remove('loading'); // this.autoplay.start();
      },
      progress: function () {
        let swiper = this;
        ...
        for (let i = 0; i < swiper.slides.length; i++) {
          ...
          swiper.slides[i].querySelector(".image-slider__bgimg").style.transform = "translateX(" + innerTranslate + "px)";
        }
      },
      touchStart: function () {
        let swiper = this;
      ...
      setTransition: function (speed) {
        ...
        for (let i = 0; i < swiper.slides.length; i++) {
          ...
          swiper.slides[i].querySelector(".image-slider__bgimg").style.transition = speed + "ms";
        }
      }
    }
  };
...
const favoritTabsToggle = () => {
  $('.favorit-tabs__list-item').click(function () {
    let tabNum = $(this).attr('data-tab');
    $('.favorit-tabs__list-item').removeClass('favorit-tabs__list-item_current'); // $('.tab-content').removeClass('tab-content_current');

    $(this).addClass('favorit-tabs__list-item_current'); // $("."+tabNum).addClass('tab-content_current');
  });
};