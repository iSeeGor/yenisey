...
const modalTheme = () => {
  ...
  let header = document.querySelector('.header'); // Modal Form
  ...
  let closeVideoPopup = document.querySelector(".video-popup__close-btn"); // Add Styles when popup open
